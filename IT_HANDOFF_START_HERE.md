...
The dashboard redesign audit and KPI definitions are in `docs/unified-dashboard-kpi-audit.md`. The attorney dashboard's top measures are Overdue, Due Today, Next 7 Days, Action Queue, and Hard Dates within 90 days. Its urgency and hard-date bar summaries are keyboard-accessible, show values without hover, and route to Work Queue or Calendar. Division Overview uses separate management measures for Management Attention, hard dates within 90 days, jury trials within 180 days, pipeline stalls, and service risk beginning at day 90. The management visuals are limited to hard-date ranges, jury trials by primary attorney, and pipeline aging by stage; they are observational staffing/exception views and do not rank attorney performance or use opaque workload scores.
