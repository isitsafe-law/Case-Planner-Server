...
- Legal Assistant attorney follow-up foundation: the preparation page now reuses the existing case-level Waiting/Action Queue workflow to record an attorney request, requested action, follow-up date, and activity history. It does not imply an email was sent or create a duplicate reminder record.
