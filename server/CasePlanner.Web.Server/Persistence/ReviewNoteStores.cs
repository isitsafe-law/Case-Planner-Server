...
// ICircuitClerkStore: a plain interface, implemented once per provider, selected in Program.cs's DI
// registration by active database provider. Append-only, like IPipelineHolderApprovalStore -
// read/insert only, no update, no delete, since a review note is never edited or retracted once
// entered.
